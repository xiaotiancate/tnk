...
class Block extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\shop\Block;
        $this->view->assign("statusList", $this->model->getStatusList());
    }

    public function index()
    {
        $typeArr = \app\admin\model\shop\Block::distinct('type')->column('type');
    ...
    public function selectpage_type()
    {
        ...
        if (!$keyValue) {
            ...
            $typeArr = \app\admin\model\shop\Block::column('type');
    ...
    public function edit($ids = null)
    {
        ...
        $values = \app\admin\model\shop\Block::get($ids);
        if (!$values) {
