...
class Page extends Backend
{
    ...
    {
        $typeArr = \app\admin\model\shop\Page::distinct('type')->column('type');
    ...
    public function edit($ids = null)
    {
        ...
        $values = \app\admin\model\shop\Page::get($ids);
        if (!$values) {
    ...
    {
        if (!$this->auth->check('shop/page/index')) {
    ...
    public function selectpage_type()
    {
        ...
        if (!$keyValue) {
            ...
            $typeArr = \app\admin\model\shop\Page::column('type');
