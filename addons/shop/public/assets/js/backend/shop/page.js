define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'shop/page/index',
                    add_url: 'shop/page/add',
                    edit_url: 'shop/page/edit',
                    del_url: 'shop/page/del',
                    multi_url: 'shop/page/multi',
                    table: 'shop_page',
                }
            });
                ...
                $.validator.config({
                    rules: {
                        diyname: function (element) {
                            ...
                            return $.ajax({
                                url: 'shop/page/check_element_available',
                                type: 'POST',
