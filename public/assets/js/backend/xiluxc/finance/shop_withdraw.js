define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/finance/shop_withdraw/index' + location.search,
                    add_url: '',
                    edit_url: 'xiluxc/finance/shop_withdraw/edit',
                    del_url: '',
                    multi_url: '',
                        ...
                        {field: 'operate', title: __('Operate'), buttons: [
                                {
                                    ...
                                    icon: '',
                                    confirm: '确认设置为处理中？',
                                    url: 'xiluxc/finance/shop_withdraw/processing',
                                ...
                                },
                                {
                                    ...
                                    click: function (data,row) {
                                        Layer.prompt({
                                            ...
                                            Fast.api.ajax({
                                                url: 'xiluxc/finance/shop_withdraw/refuse/ids/'+row.id,
                                                data: {reason:value},
                                            },function () {
                                                Layer.close(index);
                                                table.bootstrapTable('refresh',{});
