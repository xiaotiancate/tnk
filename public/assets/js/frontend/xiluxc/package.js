define(['jquery', 'bootstrap', 'backend', 'table', 'form','vue'], function ($, undefined, Backend, Table, Form,Vue) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/package/index' + location.search,
                    add_url: 'xiluxc/package/add',
                    edit_url: 'xiluxc/package/edit',
                    del_url: 'xiluxc/package/del',
                    multi_url: 'xiluxc/package/multi',
                    dragsort_url: '',
        ...
        selects: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/package/selects' + location.search,
                    dragsort_url: "",
                    table: 'xiluxc_shop_package',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'category_id', title: __('分类'),searchList: Config.categoryList, formatter: Table.api.formatter.normal},
                        {field: 'name', title: __('Name'), operate: 'LIKE'},
                        {field: 'status', title: __('Status'), searchList: {"hidden":__('Status hidden'),"normal":__('Status normal')}, formatter: Table.api.formatter.status},
