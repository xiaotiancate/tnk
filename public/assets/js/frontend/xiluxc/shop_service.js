define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/shop_service/index' + location.search,
                    add_url: 'xiluxc/shop_service/add',
                    edit_url: 'xiluxc/shop_service/edit',
                    del_url: 'xiluxc/shop_service/del',
                    multi_url: 'xiluxc/shop_service/multi',
                    dragsort_url: '',
        ...
        selects: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/shop_service/selects' + location.search,
                    dragsort_url: "",
                    table: 'xiluxc_shop_service',
                }
            });
