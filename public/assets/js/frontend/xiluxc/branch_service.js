define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/branch_service/index' + location.search,
                    add_url: '',
                    edit_url: 'xiluxc/branch_service/edit',
                    del_url: '',
                    multi_url: 'xiluxc/branch_service/multi',
                    dragsort_url: '',
                    table: 'xiluxc_shop_branch_service',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'shop_service.service.name', title: __('Service_id'),operate:"LIKE"},
                        {field: 'shop_service.image', title: __('Image'), operate: false, events: Table.api.events.image, formatter: Table.api.formatter.image},
                        {field: 'shop_service.salesprice', title: __('Salesprice'), operate:false},
                        {field: 'shop_service.vip_price', title: __('Vip_price'), operate:false},
                        {field: 'status', title: __('Status'), searchList: {"hidden":__('Status hidden'),"normal":__('Status normal')},yes: 'normal',no:'hidden', formatter: Table.api.formatter.normal},
        ...
        selects: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/branch_service/selects' + location.search,
                    dragsort_url: "",
                    table: 'xiluxc_shop_branch_service',
                }
            });
