define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/order/index' + location.search,
                    add_url: 'xiluxc/order/add',
                    edit_url: 'xiluxc/order/edit',
                    del_url: 'xiluxc/order/del',
                    multi_url: 'xiluxc/order/multi',
                    table: 'xiluxc_order',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'xiluxc/order/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
