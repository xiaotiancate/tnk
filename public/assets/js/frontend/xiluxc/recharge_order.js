define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'xiluxc/recharge_order/index' + location.search,
                    add_url: '',
                    edit_url: 'xiluxc/recharge_order/edit',
                    del_url: 'xiluxc/recharge_order/del',
                    multi_url: 'xiluxc/recharge_order/multi',
