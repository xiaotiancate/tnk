...
class Console extends XiluxcFront
{
...
//        }
        [$userCount,$orderServiceCount,$orderSum,$rechargeCount,$orderPackageCount] = $this->statics('d');

        //本周
        [$userCount2,$orderServiceCount2,$orderSum2,$rechargeCount2,$orderPackageCount2] = $this->statics('w');

        //本月
        [$userCount3,$orderServiceCount3,$orderSum3,$rechargeCount3,$orderPackageCount3] = $this->statics('m');
...
//            'sevendnu'          => User::whereTime('jointime', '-7 days')->count(),
    ...
    protected function statics($type='d'){
        ...
        return [$userCount,$orderServiceCount,$orderSum,$rechargeCount,$orderPackageCount];
    }
