...
//            dump($list);die();
            foreach ($list as $k => $v) {
                ...
                $v->account->first_username = $v->account->first_user_id?\app\admin\model\User::where('id',
                    $v->account->first_user_id)->value('nickname'):'-';
                $v->account->second_username = $v->account->first_user_id?\app\admin\model\User::where('id',$v->account->second_user_id)->value('nickname'):'-';
            }
