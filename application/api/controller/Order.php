...
class Order extends Api
{
    ...
    public function tuika(){
        ...
        // 基础交易信息
        $json = [
            "IttParty_Stm_ID" => "TESTO",
            "Py_Chnl_Cd" => 1,
            "IttParty_Tms" => "20180628101113019",
            "IttParty_Jrnl_No" => "23123456789012345678901234567896", // 注意：不可重复
            "Mkt_ID" => "0001",
            "Mkt_Mrch_ID" => "0002",
            "UDF_ID" => "0003",
            "PyMd_Cd" => "01",
        ...
        $json['prjListJsonArray'] = $prjList;
        
        // 添加签名信息（需替换实际签名）
        $json['SIGN_INNF'] = $signInf; 
        
        $jsonStr = json_encode($json, JSON_UNESCAPED_UNICODE);
        echo "传入的JSON串: " . $jsonStr;
